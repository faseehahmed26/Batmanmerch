	    ...
	    <div class="container">
	        <div class="col-md-6">
	            	<div class="login-box">
	            		 ...
	            		 <br>
	            		 <form action="<?php echo controller('registeruser'); ?>" class="padrl-20 row" method="POST">
								<div class="form-group col-md-6">
									<input type="firstname" name="firstname" class="form-control" id="firstname" placeholder="Firstname" 
									value="<?php if (isset($values['firstname'])){echo $values['firstname']; } ?>">
								...
								<div class="form-group col-md-6">
									<input type="email" name="email" class="form-control" id="email" placeholder="Email" value="<?php if (isset($values['email'])){echo $values['email']; } ?>">
								...
								<div class="form-group col-md-12">
									<input type="password" name="password" class="form-control" id="password" placeholder="Paassword" value="<?php if (isset($values['password'])){echo $values['password']; } ?> ">
